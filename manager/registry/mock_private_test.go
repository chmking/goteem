...
func (m *MockAgentClient) Heartbeat(arg0 context.Context, arg1 *private.HeartbeatRequest, arg2 ...grpc.CallOption) (*private.HeartbeatResponse, error) {
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "Heartbeat", varargs...)
	ret0, _ := ret[0].(*private.HeartbeatResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Heartbeat indicates an expected call of Heartbeat
func (mr *MockAgentClientMockRecorder) Heartbeat(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Heartbeat", reflect.TypeOf((*MockAgentClient)(nil).Heartbeat), varargs...)
}
